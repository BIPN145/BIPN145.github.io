...
## Graded Components
* [Research proposal](#heading=h.d4pp5nss6cxu) (50 pts): 1 page proposal of what you intend to do, submitted as a group
* [In-class presentation](#heading=h.g3g1fxgrfsi9)(75 pts): Group components and individual components
* [Project lab report](#heading=h.b2dn5qk6672p)(100 pts): Individually written, but your figures may be shared across group members.
...
**Note**: If you decide to do an EEG experiment, you must:
...
50 points, submitted as a group
...
Your proposal should have a meaningful **title** and a list of your group members. It should have the following components, each  **~1 paragraph** (unless otherwise specified): 
...
1. Investigate the adaptation of T and P cells in leech ganglia when the skin is stimulated with prolonged and intermittent touch.
...
Your report should have every part of a full report: Abstract, Introduction, Methods, Results, Discussion, and References. The word counts and reference requirements for Abstract, Introduction, and Discussion for [lab reports in BIPN 145](http://bit.ly/BIPN145_labreports) still apply. **In total, your report should not exceed 5 pages.**
